  ...
  const handleSave = async (data: TFormDataInterno) => {
    ...
    if (file) {
      ...
      if (uploadResult instanceof Error) {
        const fallbackUrl = "http://localhost:8989/uploads/blackdefaultavatar.png"
        await UploadService.getByfile(fallbackUrl).then((data) => {
