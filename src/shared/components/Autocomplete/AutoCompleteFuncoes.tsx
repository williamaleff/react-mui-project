// src/shared/components/AutoCompleteFuncoes.tsx

import { Autocomplete, CircularProgress, TextField } from "@mui/material";
import { Controller } from 'react-hook-form';
import { useCallback, useEffect, useMemo, useState } from "react";
import { FuncoesService } from "../../services/api/funcoes/FuncoesService";
...
export const AutoCompleteFuncoes: React.FC<IAutoCompleteFuncoesProps> = ({
    control,
    name,
    errors,
    isLoading,
