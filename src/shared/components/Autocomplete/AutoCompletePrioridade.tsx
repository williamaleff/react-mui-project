// src/shared/components/AutoCompletePrioridade.tsx

import { Autocomplete, CircularProgress, TextField } from "@mui/material";
import { Controller } from 'react-hook-form';
import { useCallback, useEffect, useMemo, useState } from "react";
import { PrioridadeService } from "../../services/api/prioridade/PrioridadeService";
...
interface IAutoCompletePrioridadeProps {
...
export const AutoCompletePrioridade: React.FC<IAutoCompletePrioridadeProps> = ({
    control,
    name,
    errors,
    isLoading,
    ...
    const fetchData = useCallback(() => {
        PrioridadeService.getAll(1, busca)
            .then((result) => {
